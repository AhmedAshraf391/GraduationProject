...
export default function VerifyOTP() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    console.log("Submitting OTP:", { userEmail, enteredOTP });

    try {
      const result = await verifyEmail(userEmail, enteredOTP);
      console.log("verifyEmail Response:", result);
      if (result.success) {
        setSuccess(true);
        setTimeout(() => {
          router.push("/");
  ...
  const handleResendOTP = async () => {
    ...
    setIsExpired(false);
    // Call resend OTP API (e.g., await someResendFunction(userEmail))
    console.log("Resend OTP requested for:", userEmail);
